...
def options():
    ...
    parser.add_argument('--recipe', default='targeted', type=str, choices=['grad_explosion', 'tensorclog',
                                                                                    'untargeted', 'targeted', 'targeted_mc'])
    ...
    # Settings for causal model
    parser.add_argument('--causal_model_path', default=None, type=str, help='path to causal model state dict')
    parser.add_argument('--causal_config', action='append',
                        help='an optional config file', default=None, type=str)
    parser.add_argument('--causal_data_no_normalize', action='store_true')
    parser.add_argument('--causal_beta', default=0.1, type=float)
    parser.add_argument('--causal_loss_type', default='perturb_s', type=str)
    parser.add_argument('--only_causal', action='store_true')
    parser.add_argument('--causal_reverse', action='store_true')
    parser.add_argument('--st4causal', action='store_true')
